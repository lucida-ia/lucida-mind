...
determinística** (ver [tecnico/billing-ledger.md](../tecnico/billing-ledger.md)), não por token consumido. Os preços de **plano de aula**
...
[tecnico/integracoes.md](../tecnico/integracoes.md)). O material extraído alimenta a geração de provas/planos.
...
`pageTextSegments` persistidos — ver [tecnico/biblioteca.md](../tecnico/biblioteca.md).
...
retroativo; `--dry-run` disponível). Ver [tecnico/stack.md](../tecnico/stack.md).
...
[tecnico/biblioteca.md](../tecnico/biblioteca.md).
...
Ver [tecnico/arquitetura.md](../tecnico/arquitetura.md).
