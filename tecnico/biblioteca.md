...
`regenerate-*`, ao lado de PDF/DOCX/texto/YouTube (ver [tecnico/ai-ops.md](../tecnico/ai-ops.md)).
...
[tecnico/calendario.md](../tecnico/calendario.md)). No backend, o middleware `requireLibraryAccess` gateia os endpoints (acesso negado
...
e o `ai-ops` fatia antes do prompt. Ver [tecnico/ai-ops.md](../tecnico/ai-ops.md).
